...
StackName="wsus"
Template="wsus.template.json"
AMIID="ami-0ecbd53f8048315c9"
MicrosoftADPW="Datacom2018!"
BaseURL="olgr.hcs.datacom.com.au"
WSUSEndpoint="aws.olgr.ops@hcs.datacom.com.au"
# End of Customzation 
...
then
	...
	--template-body file://${Template} \
    	...
    	--parameters \
    	  ...
    	  ParameterKey=WSUSEndpoint,ParameterValue=${WSUSEndpoint} \
