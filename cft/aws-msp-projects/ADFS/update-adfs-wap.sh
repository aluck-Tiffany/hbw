...
StackName="adfs-wap"
Template="adfs-wap-with-userdata.template.json"
MicrosoftADPW="Datacom2018!"
AdfsSvcUserPW="Adfs_Datacom2018!"
AMIID="ami-0ecbd53f8048315c9"
AcmCertificateArn="arn:aws:acm:us-east-1:545641818208:certificate/801a59a3-9b16-4ce5-84f8-68cbeb0d4f57"
...
then
	...
	--template-body file://${Template} \
    	...
    	--parameters \
    	  ...
    	  ParameterKey=AdfsSvcUserPW,ParameterValue=${AdfsSvcUserPW} \
